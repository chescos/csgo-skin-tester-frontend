<template>
  <div id="app" class="bg-gray-900 text-white min-h-screen" v-cloak>
        ...
        <div class="container px-6 mx-auto flex items-center justify-between flex-wrap">
          ...
          <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="text-sm lg:flex-grow">
              <router-link v-for="(category, slug) in categories" :to="{ name: 'category', params: { category: slug }}"
                           :key="slug">
                <a class="block mt-4 lg:inline-block lg:mt-0 text-blue-100 hover:text-white mr-4">
                  {{ category.name }}
                </a>
              </router-link>
            </div>
